...
REM INSTALL: ISS (International SpaceStation) Dep-1:
	...
	REM powershell -command "& { iwr https://github.com/R-T-B/Kopernicus/releases/download/UBE-release-57/KopernicusBE_111_Release57.zip -OutFile KopernicusBE_111_Release57.zip }"
	REM powershell.exe -NoP -NonI -Command "Expand-Archive 'KopernicusBE_111_Release57.zip' '%KSPTEMP%'"
	...
	REM move KopernicusBE_111_Release57.zip %KSPTEMP%
