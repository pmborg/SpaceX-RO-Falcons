...
//              "boot/stage-boosters.ks" file.
//				Used for RIGHT BOOSTER of Falcon Heavy, (will be used later as a signature)
// 14/Nov/2020
// --------------------------------------------------------------------------------------------

SWITCH TO 0.	//SWITCH TO default PATH: [KSP]/Ships/Script
runpath("boot/stage-boosters.ks").